...
function initHistoria() {
  ...
  const stories = {
    ...
    cocina: {
      ...
      content: `<h3>La pasta que<br><em>nace cada mañana</em></h3>
        <p>Antes de que abra el restaurante, nuestra cocina ya lleva horas activa. La pasta fresca se elabora cada mañana con harina italiana tipo "00" y huevos frescos, siguiendo recetas de generación en generación.</p>
        <p>Las pappardelle, el plato que da nombre al restaurante, requieren habilidad y paciencia. Se extiende la masa a mano, se corta en tiras anchas y se cuelga a secar. Ese mismo día llega a tu mesa con nuestro ragù de 48 horas.</p>`
    }
  };
...
/* ─── AI Assistant ─── */
const RESTAURANT_CONTEXT = `Eres el asistente virtual de La Pappardella, restaurante italiano en Puerto Calero, Lanzarote. Teléfono: +34 928 513 614. Horarios: todos los días 12:30-15:30h y 18:30-23:00h. Especialidades: pasta fresca artesanal, Pappardelle al Ragù (48h), Spaghetti alle Vongole. Vinos: DO Lanzarote (Malvasía volcánica) e italianos (Barolo, Brunello, Chianti). Más de 25 años en Lanzarote. Responde en el idioma del usuario. Sé cálido y conciso (máx 3 párrafos).`;
...
const TRANSLATIONS = {
  es: {
    ...
    's1.label':'001 / Origen','s1.heading':'Donde Italia<br><em>se encuentra</em><br>con el Atlántico','s1.body':'Pasta fresca cada mañana, veleros al atardecer y el rumor eterno del océano. Un rincón de Italia en el corazón de Lanzarote, con vistas al puerto.','s1.cta':'Reservar terraza →',
    ...
    'hist.body1':'La Pappardella nació de una pasión irrenunciable: traer la autenticidad de la cocina italiana al lugar más inesperado del Atlántico. Lanzarote, con su paisaje volcánico único y su luz de otro mundo, se convirtió en el hogar perfecto para una cocina que habla de raíces y saber hacer.',
    'hist.body2':'Más de 25 años después, seguimos fieles a ese sueño: pasta fresca cada mañana, mariscos del Atlántico, y vinos nacidos del volcán.',
    ...
    'pillar3.strong':'Tradición Italiana','pillar3.p':'Pasta artesanal elaborada cada mañana',
    'pillar4.strong':'Luz Única','pillar4.p':'Reserva de la Biosfera UNESCO',
    'carta.eyebrow':'002 / Nuestra carta','carta.title':'Sabores<br>que<br><em>cuentan<br>historias</em>','carta.desc':'Pasta artesanal elaborada cada mañana, mariscos del Atlántico y los mejores ingredientes de temporada.','carta.cta':'Menú Completo','carta.hint':'Descubre los platos →',
    ...
    'faq.q5':'¿La pasta es realmente artesanal?','faq.a5':'Absolutamente. Nuestro chef elabora la pasta fresca cada mañana con harina italiana tipo "00" y huevos frescos, siguiendo recetas centenarias.',
  ...
  en: {
    ...
    's1.label':'001 / Origins','s1.heading':'Where Italy<br><em>meets</em><br>the Atlantic','s1.body':'Fresh pasta every morning, sailboats at sunset and the eternal sound of the ocean. A corner of Italy in the heart of Lanzarote, overlooking the marina.','s1.cta':'Book the terrace →',
    ...
    'hist.body1':'La Pappardella was born from an irresistible passion: bringing the authenticity of Italian cuisine to the most unexpected corner of the Atlantic. Lanzarote, with its unique volcanic landscape and otherworldly light, became the perfect home for a cuisine that speaks of roots and craftsmanship.',
    'hist.body2':'Over 25 years later, we remain true to that dream: fresh pasta every morning, Atlantic seafood, and wines born from the volcano.',
    ...
    'pillar3.strong':'Italian Tradition','pillar3.p':'Handmade pasta crafted every morning',
    'pillar4.strong':'Unique Light','pillar4.p':'UNESCO Biosphere Reserve',
    'carta.eyebrow':'002 / Our Menu','carta.title':'Flavours<br>that<br><em>tell<br>stories</em>','carta.desc':'Handmade pasta crafted every morning, Atlantic seafood and the finest seasonal ingredients.','carta.cta':'Full Menu','carta.hint':'Discover the dishes →',
    ...
    'faq.q5':'Is the pasta really handmade?','faq.a5':'Absolutely. Our chef prepares fresh pasta every morning with Italian "00" flour and fresh eggs, following centuries-old recipes.',
  ...
  fr: {
    ...
    's1.label':'001 / Origines','s1.heading':'Là où l\'Italie<br><em>rencontre</em><br>l\'Atlantique','s1.body':'Pâtes fraîches chaque matin, voiliers au coucher du soleil et le murmure éternel de l\'océan. Un coin d\'Italie au cœur de Lanzarote, face au port.','s1.cta':'Réserver la terrasse →',
    ...
    'hist.body1':'La Pappardella est née d\'une passion irrésistible : apporter l\'authenticité de la cuisine italienne dans le coin le plus inattendu de l\'Atlantique. Lanzarote, avec son paysage volcanique unique et sa lumière d\'un autre monde, est devenu le foyer parfait pour une cuisine qui parle de racines et de savoir-faire.',
    'hist.body2':'Plus de 25 ans après, nous restons fidèles à ce rêve : pâtes fraîches chaque matin, fruits de mer de l\'Atlantique et vins nés du volcan.',
    ...
    'pillar3.strong':'Tradition Italienne','pillar3.p':'Pâtes artisanales préparées chaque matin',
    'pillar4.strong':'Lumière Unique','pillar4.p':'Réserve de Biosphère UNESCO',
    'carta.eyebrow':'002 / Notre Menu','carta.title':'Saveurs<br>qui<br><em>racontent<br>des histoires</em>','carta.desc':'Pâtes artisanales préparées chaque matin, fruits de mer de l\'Atlantique et les meilleurs ingrédients de saison.','carta.cta':'Menu Complet','carta.hint':'Découvrez les plats →',
    ...
    'faq.q5':'Les pâtes sont-elles vraiment artisanales ?','faq.a5':'Absolument. Notre chef prépare les pâtes fraîches chaque matin avec de la farine italienne type "00" et des œufs frais, en suivant des recettes centenaires.',
  ...
  de: {
    ...
    's1.label':'001 / Ursprung','s1.heading':'Wo Italien<br><em>auf den</em><br>Atlantik trifft','s1.body':'Frische Pasta jeden Morgen, Segelboote beim Sonnenuntergang und das ewige Rauschen des Ozeans. Ein Stück Italien im Herzen von Lanzarote, mit Blick auf den Hafen.','s1.cta':'Terrasse reservieren →',
    ...
    'hist.body1':'La Pappardella entstand aus einer unwiderstehlichen Leidenschaft: die Authentizität der italienischen Küche an den unerwartetsten Ort des Atlantiks zu bringen. Lanzarote, mit seiner einzigartigen Vulkanlandschaft und seinem unwirklichen Licht, wurde zum perfekten Zuhause für eine Küche, die von Wurzeln und Können erzählt.',
    'hist.body2':'Mehr als 25 Jahre später bleiben wir diesem Traum treu: frische Pasta jeden Morgen, Meeresfrüchte aus dem Atlantik und Weine vom Vulkan.',
    ...
    'pillar3.strong':'Italienische Tradition','pillar3.p':'Handgemachte Pasta, täglich frisch zubereitet',
    'pillar4.strong':'Einzigartiges Licht','pillar4.p':'UNESCO-Biosphärenreservat',
    'carta.eyebrow':'002 / Unsere Speisekarte','carta.title':'Aromen,<br>die<br><em>Geschichten<br>erzählen</em>','carta.desc':'Handgemachte Pasta, täglich frisch, Meeresfrüchte aus dem Atlantik und die besten Saisonzutaten.','carta.cta':'Vollständige Speisekarte','carta.hint':'Gerichte entdecken →',
    ...
    'faq.q5':'Ist die Pasta wirklich handgemacht?','faq.a5':'Absolut. Unser Koch bereitet täglich frische Pasta mit italienischem Mehl Typ "00" und frischen Eiern zu, nach jahrhundertealten Rezepten.',
  ...
  it: {
    ...
    's1.label':'001 / Origini','s1.heading':'Dove l\'Italia<br><em>incontra</em><br>l\'Atlantico','s1.body':'Pasta fresca ogni mattina, barche a vela al tramonto e il suono eterno dell\'oceano. Un angolo d\'Italia nel cuore di Lanzarote, con vista sul porto.','s1.cta':'Prenota la terrazza →',
    ...
    'hist.body1':'La Pappardella è nata da una passione irresistibile: portare l\'autenticità della cucina italiana nel posto più inaspettato dell\'Atlantico. Lanzarote, con il suo paesaggio vulcanico unico e la sua luce di un altro mondo, è diventata la casa perfetta per una cucina che parla di radici e maestria.',
    'hist.body2':'Oltre 25 anni dopo, restiamo fedeli a quel sogno: pasta fresca ogni mattina, frutti di mare dell\'Atlantico e vini nati dal vulcano.',
    ...
    'pillar3.strong':'Tradizione Italiana','pillar3.p':'Pasta artigianale preparata ogni mattina',
    'pillar4.strong':'Luce Unica','pillar4.p':'Riserva della Biosfera UNESCO',
    'carta.eyebrow':'002 / Il Nostro Menu','carta.title':'Sapori<br>che<br><em>raccontano<br>storie</em>','carta.desc':'Pasta artigianale preparata ogni mattina, frutti di mare dell\'Atlantico e i migliori ingredienti di stagione.','carta.cta':'Menu Completo','carta.hint':'Scopri i piatti →',
    ...
    'faq.q5':'La pasta è davvero fatta a mano?','faq.a5':'Assolutamente. Il nostro chef prepara la pasta fresca ogni mattina con farina italiana tipo "00" e uova fresche, seguendo ricette centenarie.',
